# to build image, cd to dockerfile directory and run docker build -t ebay-image .
# to start, run docker run -d --name=ebay-container --mount source=ebay,target=/usr/src/ebay ebay-image
